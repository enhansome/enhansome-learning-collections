...
* [Coding Interview University](https://github.com/jwasham/coding-interview-university) ⭐ 358,971 | 🐛 123 | 📅 2025-08-28 - A pretty comprehensive checklist of things to learn and review to prepare for a coding interview.
* [Open Source Society University Computer Science Path](https://github.com/ossu/computer-science) ⭐ 208,056 | 🐛 25 | 🌐 HTML | 📅 2026-07-14 - Teach yourself Computer Science without spending a dime.
* [Javascript Algorithms](https://github.com/trekhleb/javascript-algorithms) ⭐ 196,496 | 🐛 404 | 🌐 JavaScript | 📅 2026-07-26 - *Algorithms and data structures implemented in JavaScript with explanations and links to further readings.*
* [Tech Interview Handbook](https://github.com/yangshun/tech-interview-handbook) ⭐ 141,910 | 🐛 34 | 🌐 TypeScript | 📅 2026-08-07 - *Algorithms study materials, behavioral content and tips for rocking your coding interview.*
* [Computer Science Courses with Video Lectures](https://github.com/Developer-Y/cs-video-courses) ⭐ 83,059 | 🐛 2 | 📅 2026-07-07 - *List of Computer Science courses with video lectures*.
* [Interviews](https://github.com/kdn251/interviews) ⭐ 65,200 | 🐛 121 | 🌐 Java | 📅 2025-05-12 - *Everything you need to get the job.*
* [Interactive Coding Challenges](https://github.com/donnemartin/interactive-coding-challenges) ⭐ 31,728 | 🐛 75 | 🌐 Python | 📅 2024-05-08 - *Interactive Python coding interview challenges (algorithms and data structures).*
...
* [Cosmos](https://github.com/OpenGenus/cosmos) ⭐ 13,739 | 🐛 2,600 | 🌐 C++ | 📅 2024-10-05 - Your personal library of every algorithm and data structure code that you will ever encounter
...
* [Learn Math Fast](https://github.com/llSourcell/learn_math_fast) ⭐ 3,294 | 🐛 3 | 🌐 Python | 📅 2019-10-12 - *This is the Curriculum for "How to Learn Mathematics Fast" By Siraj Raval on Youtube.*
...
* [Awesome Data Science](https://github.com/bulutyazilim/awesome-datascience) ⭐ 29,832 | 🐛 7 | 📅 2026-08-10 - A curated list of resources for learning Data Science.
* [Machine Learning for Software Engineers](https://github.com/ZuzooVn/machine-learning-for-software-engineers) ⭐ 28,860 | 🐛 32 | 📅 2024-06-11 - A practical approach to machine learning.
* [Open Source Society University Data Science Path](https://github.com/ossu/data-science) ⭐ 21,891 | 🐛 4 | 📅 2025-05-13 - Teach yourself Data Science without spending a dime!
...
* [Web Developer Roadmap](https://github.com/kamranahmedse/developer-roadmap) ⭐ 364,654 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-14 - Roadmap to becoming a web developer.
* [You Don't Know JS](https://github.com/getify/You-Dont-Know-JS) ⭐ 184,684 | 🐛 2 | 📅 2026-02-15 - *This is a series of books diving deep into the core mechanisms of the JavaScript language.*
* [Node Best Practices](https://github.com/i0natan/nodebestpractices) ⭐ 105,567 | 🐛 136 | 🌐 Dockerfile | 📅 2026-06-15 - A list of best practices in Node and its ecosystem.
* [Real World Apps](https://github.com/gothinkster/realworld) ⭐ 84,086 | 🐛 32 | 🌐 TypeScript | 📅 2026-08-13 - *See how the exact same Medium.com clone (called Conduit) is built using any of our supported frontends and backends. Yes, you can mix and match them, because they all adhere to the same API spec 😮😎*.
* [Front End Checklist](https://github.com/thedaviddias/Front-End-Checklist) ⭐ 73,541 | 🐛 6 | 🌐 MDX | 📅 2026-08-14 - *The Front-End Checklist Application is perfect for modern websites and meticulous developers!*
* [Frontend Developer Interview Questions](https://github.com/h5bp/Front-end-Developer-Interview-Questions) ⭐ 60,878 | 🐛 63 | 🌐 Nunjucks | 📅 2026-06-16 - Ace your frontend developer interview by reviewing these questions.
...
* [AWS Open Guide](https://github.com/open-guides/og-aws) ⭐ 36,438 | 🐛 159 | 🌐 Shell | 📅 2024-08-16 - A practical guide to AWS.
...
* [JS Stack from Scratch](https://github.com/verekia/js-stack-from-scratch) ⭐ 20,148 | 🐛 49 | 🌐 JavaScript | 📅 2024-06-05 - *Step-by-step tutorial to build a modern JavaScript stack.*
* [Spellbook for Modern Web Dev](https://github.com/dexteryy/spellbook-of-modern-webdev) ⭐ 17,886 | 🐛 24 | 📅 2023-12-18 - *A Big Picture, Thesaurus, and Taxonomy of Modern JavaScript Web Development.*
* [Grab Frontend Guide](https://github.com/grab/front-end-guide) ⭐ 15,235 | 🐛 26 | 🌐 JavaScript | 📅 2023-06-12 - *Study guide and introduction to the modern front end stack.*
...
* [Build your own X](https://github.com/danistefanovic/build-your-own-x) ⭐ 540,290 | 🐛 630 | 🌐 Markdown | 📅 2026-07-14 - Build your own language, server, database, etc. in order to understand them.
* [Ebook Foundation Free Programming Books](https://github.com/EbookFoundation/free-programming-books/blob/master/free-programming-books.md) ⭐ 394,580 | 🐛 78 | 🌐 Python | 📅 2026-08-16 - A list of freely available programming books.
* [System Design Primer](https://github.com/donnemartin/system-design-primer) ⭐ 364,261 | 🐛 605 | 🌐 Python | 📅 2026-03-20 - *Learn how to design large-scale systems. Prep for the system design interview.*
* [Every Programmer Should Know](https://github.com/mtdvio/every-programmer-should-know) ⭐ 100,247 | 🐛 25 | 📅 2025-12-29 - *A collection of (mostly) technical things every software developer should know.*
...
* [Design Patterns for Humans](https://github.com/kamranahmedse/design-patterns-for-humans/blob/master/README.md) ⭐ 48,450 | 🐛 16 | 📅 2024-12-02 - Learn design patterns without the blood, sweat, and tears.
* [Mega Project List](https://github.com/karan/Projects) ⭐ 47,870 | 🐛 123 | 📅 2024-08-14 - *A list of practical projects that anyone can solve in any programming language.*
* [Awesome Cheatsheets](https://github.com/LeCoupa/awesome-cheatsheets) ⭐ 46,363 | 🐛 136 | 🌐 JavaScript | 📅 2026-04-12 - *Awesome cheatsheets for popular programming languages, frameworks and development tools.*
...
* [How to be a Programmer](https://github.com/braydie/HowToBeAProgrammer) ⭐ 16,305 | 🐛 7 | 📅 2025-09-28 - Learn how to be a programmer with this collection of resources.
...
* [Project-based Learning](https://github.com/tuvtran/project-based-learning) ⭐ 279,510 | 🐛 267 | 🌐 Python | 📅 2026-08-10 - Learn languages by building projects.
...
* [Awesome Hacking](https://github.com/Hack-with-Github/Awesome-Hacking) ⭐ 118,465 | 🐛 39 | 📅 2026-07-26 - *A collection of various awesome lists for hackers, pentesters and security researchers.*
* [Infosec\_Reference](https://github.com/rmusser01/Infosec_Reference) ⭐ 5,985 | 🐛 3 | 🌐 CSS | 📅 2025-10-20 - *An Information Security Reference That Doesn't Suck.*
...
* [Mind Expanding Books](https://github.com/hackerkid/Mind-Expanding-Books) ⭐ 14,147 | 🐛 33 | 🌐 JavaScript | 📅 2024-11-09 - *Books that will blow your mind.*
* [Awesome Checklist Checklist](https://github.com/huyingjie/Checklist-Checklist) ⭐ 2,959 | 🐛 10 | 🌐 JavaScript | 📅 2023-04-20 - *A Curated List of Checklists.*
