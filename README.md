...
* [Coding Interview University](https://github.com/jwasham/coding-interview-university) ⭐ 360,722 | 🐛 125 | 📅 2025-08-28 - A pretty comprehensive checklist of things to learn and review to prepare for a coding interview.
* [Open Source Society University Computer Science Path](https://github.com/ossu/computer-science) ⭐ 208,908 | 🐛 27 | 🌐 HTML | 📅 2026-07-14 - Teach yourself Computer Science without spending a dime.
* [Javascript Algorithms](https://github.com/trekhleb/javascript-algorithms) ⭐ 196,673 | 🐛 404 | 🌐 JavaScript | 📅 2026-07-26 - *Algorithms and data structures implemented in JavaScript with explanations and links to further readings.*
* [Tech Interview Handbook](https://github.com/yangshun/tech-interview-handbook) ⭐ 142,556 | 🐛 37 | 🌐 TypeScript | 📅 2026-08-07 - *Algorithms study materials, behavioral content and tips for rocking your coding interview.*
* [Computer Science Courses with Video Lectures](https://github.com/Developer-Y/cs-video-courses) ⭐ 83,466 | 🐛 5 | 📅 2026-09-06 - *List of Computer Science courses with video lectures*.
* [Interviews](https://github.com/kdn251/interviews) ⭐ 65,241 | 🐛 122 | 🌐 Java | 📅 2025-05-12 - *Everything you need to get the job.*
* [Interactive Coding Challenges](https://github.com/donnemartin/interactive-coding-challenges) ⭐ 31,801 | 🐛 75 | 🌐 Python | 📅 2024-05-08 - *Interactive Python coding interview challenges (algorithms and data structures).*
* [Minimal Python DS & Algorithms](https://github.com/keon/algorithms) ⭐ 25,548 | 🐛 4 | 🌐 Python | 📅 2026-08-30 - *Minimal examples of data structures and algorithms in Python.*
* [Interview repo by @andreis](https://github.com/andreis/interview) ⭐ 18,364 | 🐛 15 | 📅 2024-12-25 - *Everything you need to prepare for your technical interview.*
* [Cosmos](https://github.com/OpenGenus/cosmos) ⭐ 13,743 | 🐛 2,600 | 🌐 C++ | 📅 2024-10-05 - Your personal library of every algorithm and data structure code that you will ever encounter
* [Operating Systems: From 0 to 1](https://github.com/tuhdo/os01) ⭐ 13,704 | 🐛 66 | 🌐 TeX | 📅 2024-03-26 - *Bootstrap yourself to write an OS from scratch. A book for self-learner.*
* [AlgoWiki](https://github.com/vicky002/AlgoWiki) ⭐ 4,230 | 🐛 110 | 🌐 CSS | 📅 2025-08-15 - *Repository which contains links and resources on different topics of Computer Science.*
...
* [Competitive Programming Curriculum](https://github.com/AhmadElsagheer/Competitive-programming-library/tree/master/curriculum) ⭐ 2,489 | 🐛 24 | 🌐 Java | 📅 2022-07-02 - A list of resources for learning competitive programming.
...
* [Awesome Data Science](https://github.com/bulutyazilim/awesome-datascience) ⭐ 29,963 | 🐛 4 | 📅 2026-09-09 - A curated list of resources for learning Data Science.
* [Machine Learning for Software Engineers](https://github.com/ZuzooVn/machine-learning-for-software-engineers) ⭐ 28,870 | 🐛 32 | 📅 2024-06-11 - A practical approach to machine learning.
* [Open Source Society University Data Science Path](https://github.com/ossu/data-science) ⭐ 21,952 | 🐛 4 | 📅 2025-05-13 - Teach yourself Data Science without spending a dime!
...
* [Web Developer Roadmap](https://github.com/kamranahmedse/developer-roadmap) ⭐ 366,858 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-10 - Roadmap to becoming a web developer.
* [You Don't Know JS](https://github.com/getify/You-Dont-Know-JS) ⭐ 184,854 | 🐛 2 | 📅 2026-02-15 - *This is a series of books diving deep into the core mechanisms of the JavaScript language.*
* [Node Best Practices](https://github.com/i0natan/nodebestpractices) ⭐ 105,609 | 🐛 138 | 🌐 Dockerfile | 📅 2026-06-15 - A list of best practices in Node and its ecosystem.
* [Real World Apps](https://github.com/gothinkster/realworld) ⭐ 84,206 | 🐛 28 | 🌐 TypeScript | 📅 2026-08-26 - *See how the exact same Medium.com clone (called Conduit) is built using any of our supported frontends and backends. Yes, you can mix and match them, because they all adhere to the same API spec 😮😎*.
* [Front End Checklist](https://github.com/thedaviddias/Front-End-Checklist) ⭐ 74,098 | 🐛 11 | 🌐 MDX | 📅 2026-08-14 - *The Front-End Checklist Application is perfect for modern websites and meticulous developers!*
* [Frontend Developer Interview Questions](https://github.com/h5bp/Front-end-Developer-Interview-Questions) ⭐ 60,868 | 🐛 63 | 🌐 Nunjucks | 📅 2026-06-16 - Ace your frontend developer interview by reviewing these questions.
...
* [AWS Open Guide](https://github.com/open-guides/og-aws) ⭐ 36,460 | 🐛 159 | 🌐 Shell | 📅 2024-08-16 - A practical guide to AWS.
...
* [JS Stack from Scratch](https://github.com/verekia/js-stack-from-scratch) ⭐ 20,135 | 🐛 49 | 🌐 JavaScript | 📅 2024-06-05 - *Step-by-step tutorial to build a modern JavaScript stack.*
* [Spellbook for Modern Web Dev](https://github.com/dexteryy/spellbook-of-modern-webdev) ⭐ 17,902 | 🐛 24 | 📅 2023-12-18 - *A Big Picture, Thesaurus, and Taxonomy of Modern JavaScript Web Development.*
...
* [Build your own X](https://github.com/danistefanovic/build-your-own-x) ⭐ 546,467 | 🐛 639 | 🌐 Markdown | 📅 2026-07-14 - Build your own language, server, database, etc. in order to understand them.
* [Ebook Foundation Free Programming Books](https://github.com/EbookFoundation/free-programming-books/blob/master/free-programming-books.md) ⭐ 396,476 | 🐛 82 | 🌐 Python | 📅 2026-09-10 - A list of freely available programming books.
* [System Design Primer](https://github.com/donnemartin/system-design-primer) ⭐ 369,323 | 🐛 611 | 🌐 Python | 📅 2026-03-20 - *Learn how to design large-scale systems. Prep for the system design interview.*
* [Every Programmer Should Know](https://github.com/mtdvio/every-programmer-should-know) ⭐ 100,405 | 🐛 25 | 📅 2025-12-29 - *A collection of (mostly) technical things every software developer should know.*
...
* [Design Patterns for Humans](https://github.com/kamranahmedse/design-patterns-for-humans/blob/master/README.md) ⭐ 48,848 | 🐛 16 | 📅 2024-12-02 - Learn design patterns without the blood, sweat, and tears.
* [Mega Project List](https://github.com/karan/Projects) ⭐ 47,918 | 🐛 123 | 📅 2024-08-14 - *A list of practical projects that anyone can solve in any programming language.*
* [Awesome Cheatsheets](https://github.com/LeCoupa/awesome-cheatsheets) ⭐ 46,450 | 🐛 136 | 🌐 JavaScript | 📅 2026-04-12 - *Awesome cheatsheets for popular programming languages, frameworks and development tools.*
...
* [How to be a Programmer](https://github.com/braydie/HowToBeAProgrammer) ⭐ 16,309 | 🐛 7 | 📅 2025-09-28 - Learn how to be a programmer with this collection of resources.
...
* [One Click to be Pro](https://github.com/vic317yeh/One-Click-to-Be-Pro) ⭐ 5,738 | 🐛 4 | 📅 2024-06-17 - *A list of the best resources to help you become a pro.*
...
* [Project-based Learning](https://github.com/tuvtran/project-based-learning) ⭐ 282,911 | 🐛 257 | 🌐 Python | 📅 2026-09-07 - Learn languages by building projects.
...
* [Gopher Reading List](https://github.com/enocom/gopher-reading-list) ⭐ 8,044 | 🐛 30 | 📅 2025-11-25 - *A curated selection of blog posts on Go.*
...
* [Awesome Hacking](https://github.com/Hack-with-Github/Awesome-Hacking) ⭐ 120,120 | 🐛 42 | 📅 2026-07-26 - *A collection of various awesome lists for hackers, pentesters and security researchers.*
* [Infosec\_Reference](https://github.com/rmusser01/Infosec_Reference) ⭐ 5,990 | 🐛 4 | 🌐 CSS | 📅 2025-10-20 - *An Information Security Reference That Doesn't Suck.*
...
* [CryptoList](https://github.com/coinpride/CryptoList) ⭐ 4,479 | 🐛 135 | 📅 2024-06-19 - *Curated collection of blockchain & cryptocurrency resources.*
...
* [Mind Expanding Books](https://github.com/hackerkid/Mind-Expanding-Books) ⭐ 14,239 | 🐛 33 | 🌐 JavaScript | 📅 2024-11-09 - *Books that will blow your mind.*
* [Awesome Checklist Checklist](https://github.com/huyingjie/Checklist-Checklist) ⭐ 2,967 | 🐛 10 | 🌐 JavaScript | 📅 2023-04-20 - *A Curated List of Checklists.*
* [Warren](https://github.com/torchhound/warren) ⭐ 401 | 🐛 0 | 🌐 Python | 📅 2018-10-12 - A curated list of rabbitholes.
